...
* Переменные окружения (`.env`): `AI_GATEWAY_URL`, `AI_GATEWAY_TIMEOUT`, `SITE_OWNER_EMAIL`, `MAIL_SIGNATURE` (подпись в письмах-уведомлениях), `RATE_LIMIT_CONTACT_PER_MINUTE`, `FEEDBACK_NAME_MAX_LENGTH`, `FEEDBACK_COMMENT_MAX_LENGTH`.
