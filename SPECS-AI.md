...
## Извлекаемые данные
* Ориентировочная структура (не жёсткий контракт на данном этапе, строго не валидируется) — см. `directives/AI/entities.md`: `order`/`pet`/`products`/`intent` и т.п.
